...
export class Carousel {
    ...
    createClones() {
        ...
        this.block.lastChild.after(this.cloneItem(initialChildren[0]));
        this.block.lastChild.after(this.cloneItem(initialChildren[1]));

        this.block.firstChild.before(this.cloneItem(initialChildren[initialChildren.length - 1]));
        this.block.firstChild.before(this.cloneItem(initialChildren[initialChildren.length - 2]));
    }
